...
<body>
    ...
    <section id="introduction">
        ...
        <button type="button" onclick="window.location.href='../singup/singup.php';" class="btn btn-primary btn-lg">Sign-up</button>
        </div>
        </div>
    </section>
            ...
            <div class="overview-body">
              <div class="Modern-equipment overview-card">
                <div class="overview-circle">
                    <img class="overview-icon" height="70" width="70" src="./logo/gym.png" alt="gym-equipment">
                </div>
              ...
              <div class="professional-training overview-card">
               <div class="overview-circle">
                 <img class="overview-icon" height="70" width="70" src="./logo/muscle.png" alt="muscle">
               </div>
              ...
              <div class="overview-circle">
                <img class="overview-icon" height="70" width="70" src="./logo/meal.png" alt="food">
              </div>
              ...
              <div class="overview-circle">
                <img class="overview-icon" height="90" width="90" src="./logo/heart.png" alt="heart">
              </div>
              <h4>Unique Needs</h4>
    ...
    <section id="programs">
        <div class="program-container">
            ...
            <div class="Group-program">
                <img class="group-img" src="./image/group.jpg" alt="group img">
            ...
            <div class="indivisual-program">
                <img class="individual-img" src="./image/individual.jpg" alt="individual img">
